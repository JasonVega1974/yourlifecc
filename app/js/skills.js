...
<p><strong>Choking — the Heimlich maneuver:</strong> Stand behind them, wrap arms around their waist, make a fist just above the navel, grab your fist with the other hand, thrust sharply inward and upward repeatedly. For infants: 5 back blows + 5 chest thrusts alternated.</p>`,
    ...
    q:[
      {q:'Why does CPR timing matter so critically in cardiac arrest?',opts:['CPR only works within the first 60 seconds','Brain damage begins after 4-6 minutes without circulation — the average ambulance arrives in 7-14 minutes','CPR is only effective before emergency services can be called','CPR effectiveness decreases by 10% with each passing minute indefinitely'],ans:1,explain:'Brain cells begin dying within 4-6 minutes without oxygen. With average ambulance response times of 7-14 minutes, bystander CPR bridges this gap. Every minute of CPR before paramedics arrive significantly improves survival and neurological outcomes.'},
      {q:'The song "Stayin\' Alive" is used as a CPR timing reference because:',opts:['The lyrics describe proper CPR technique','Its beat is approximately 100-120 BPM — the recommended compression rate','It\'s universally recognized and reduces panic','The American Heart Association holds the copyright and uses it in training'],ans:1,explain:'CPR compressions should be delivered at 100-120 per minute. "Stayin\' Alive" happens to be approximately 103 BPM, making it a useful mental rhythm guide. Other songs at this tempo include "Dancing Queen" and "MMMBop."'},
      {q:'When treating severe bleeding, what should you do if the bandage soaks through?',opts:['Remove it and apply a fresh bandage','Add more material on top — removing the first layer disrupts clotting','Apply a tourniquet immediately','Elevate the limb and stop applying pressure'],ans:1,explain:'Removing a blood-soaked bandage disrupts the early clotting process. Adding material on top maintains pressure and the clotting that has begun. Only switch to a tourniquet for limb bleeding that remains life-threatening despite direct pressure.'},
      {q:'For untrained bystanders, hands-only CPR (no rescue breaths) is recommended because:',opts:['Rescue breaths are never effective','The majority of cardiac arrests occur in adults where chest compressions alone are effective, and rescue breaths can delay compressions and discourage action','Hands-only CPR has been proven superior in all cases','Rescue breaths transmit disease and are banned by the Red Cross'],ans:1,explain:'Most adult cardiac arrests are circulatory (not respiratory) in origin — the blood still contains oxygen from the last breath. Chest compressions alone circulate this oxygenated blood effectively. Additionally, removing the requirement for rescue breaths encourages more bystanders to act.'},
      {q:'In the Heimlich maneuver, where do you position your fist?',opts:['On the center of the chest','Directly on the navel','Just above the navel','Below the ribcage on the back'],ans:2,explain:'The thrust point is just above the navel — below the ribcage. This position allows the inward-upward thrust to create sufficient pressure to expel the obstruction. Too low risks abdominal injury; too high contacts the ribcage and is less effective.'}
    ]
  }
],
speaking:[
...
<ul>
  ...
  <li><strong>Filler words (um, uh, like, you know):</strong> These are caused by discomfort with silence. The cure is learning to pause intentionally — pauses signal confidence and give the audience time to absorb.</li>
    ...
    q:[
      {q:'What is the primary reason most people are poor public speakers?',opts:['Public speaking is a rare innate talent','Genetic factors determine speaking ability','They haven\'t practiced — public speaking is a skill built through repetition, not a natural gift','Anxiety makes public speaking permanently impossible for most people'],ans:2,explain:'Public speaking skill is almost entirely a function of practice. The anxiety doesn\'t disappear, but it becomes manageable and performance remains effective despite it. Professional speakers are not fearless — they\'re practiced.'},
      {q:'Why is limiting a talk to 3 main points more effective than including 10?',opts:['Audiences have short attention spans and lose interest after 3 points','The human brain retains 3 points well — more and retention drops significantly','3 points fill exactly the ideal speaking time','Audiences physically cannot process more than 3 ideas'],ans:1,explain:'Memory research consistently shows that listeners retain 3 points well and forget additional points at a high rate. Three focused, well-supported points produce more comprehension and retention than ten quickly covered ones.'},
      {q:'What causes filler words (um, uh, like) in speech?',opts:['Vocabulary limitations','Low intelligence or education level','Discomfort with silence — the brain fills pauses with sounds rather than letting silence exist','Nervousness that causes involuntary vocalization'],ans:2,explain:'Filler words are the brain\'s response to the discomfort of pausing in speech. The cure is deliberately practicing intentional pauses — learning to be comfortable with brief silence, which audiences actually interpret as confidence.'},
      {q:'What should the opening 30 seconds of any talk accomplish?',opts:['Introduce yourself thoroughly so the audience knows your credentials','Outline everything you\'re going to cover so the audience can follow along','Hook the audience\'s interest with a story, fact, question, or bold statement — earning the right to the next 5 minutes','Begin immediately with your first main point to respect the audience\'s time'],ans:2,explain:'The first 30 seconds determine whether the audience decides to engage or mentally check out. Starting with a hook — surprise, story, question — creates interest that carries the audience forward. Self-introduction and outlines come after you\'ve earned their attention.'},
      {q:'Why does reading directly from notes or slides hurt a presentation?',opts:['It violates copyright laws governing visual presentations','It makes the speaker look unprepared','It disconnects the speaker from the audience — eye contact and connection are lost','Both reading from notes and using slides are ineffective'],ans:2,explain:'Communication is fundamentally relational. Reading to an audience rather than speaking with them eliminates the eye contact, responsiveness, and human connection that makes speaking compelling. Knowing content well enough to speak conversationally transforms the experience for both speaker and audience.'}
    ]
  }
],
stress:[
...
<ul>
  ...
  <li><strong>Nature exposure:</strong> 20 minutes in natural settings measurably reduces cortisol</li>
    ...
    q:[
      {q:'Why does the stress response activate for a job interview as intensely as for a physical threat?',opts:['Job interviews genuinely threaten survival in modern society','The brain cannot distinguish between types of threats — social and psychological threats activate the same system as physical ones','Cortisol is only released in physical danger — job interview stress is purely psychological','Modern humans have rewired the stress response to be hyperactive'],ans:1,explain:'The fight-or-flight system evolved for physical survival threats. It has no filter for psychological or social threats — a presentation triggers the same biological response as a predator. This mismatch is the core of modern stress dysfunction.'},
      {q:'What is the physiological sigh, and why does it work?',opts:['A slow, deep breath that activates the parasympathetic system by expanding the diaphragm','A double inhale followed by a long exhale that deflates over-inflated lung sacs sending CO₂ distress signals to the brain','A breathing technique that slows heart rate by stimulating the vagus nerve through nasal breathing','A sigh triggered involuntarily by the body to reset breathing patterns'],ans:1,explain:'The physiological sigh specifically addresses over-inflated lung air sacs (alveoli) that trigger CO₂-related anxiety signals to the brain. The double inhale reopens collapsed sacs; the long exhale efficiently dumps CO₂. It reduces subjective anxiety in under 30 seconds.'},
      {q:'Chronic elevated cortisol causes which combination of health effects?',opts:['Improved athletic performance and increased metabolism','Weight loss, improved immune function, and sharper memory','Abdominal weight gain, immune suppression, sleep disruption, and increased cardiovascular disease risk','Temporary effects only — cortisol has no lasting physiological impact'],ans:2,explain:'Chronically elevated cortisol is linked to abdominal fat accumulation, immune system suppression, sleep disruption (cortisol and sleep hormones are biologically opposed), hippocampal shrinkage affecting memory, and significantly increased cardiovascular disease risk.'},
      {q:'Why is exercise particularly effective at reducing acute stress?',opts:['Exercise directly suppresses cortisol production in the adrenal glands','The stress response was designed to end with physical action — exercise metabolizes the stress hormones the response generated','Exercise distracts the brain from stress through sensory engagement','Exercise reduces stress only through improving self-image and confidence'],ans:1,explain:'The fight-or-flight response generates cortisol and adrenaline to fuel physical action. When you exercise, you\'re completing the biological loop the stress response was designed to initiate — metabolizing the stress hormones through the intended physical action.'},
      {q:'Which factor most directly counters cortisol\'s effects through oxytocin release?',opts:['Solitary meditation and isolation','Social connection and interaction with trusted people','Sleep and rest','Dietary changes and supplements'],ans:1,explain:'Oxytocin (often called the "bonding hormone") is released during positive social interaction and directly counters cortisol\'s effects. Social connection is one of the most powerful and immediate buffers against chronic stress — explaining why isolation worsens stress outcomes.'}
    ]
  }
],
socialmedia:[
...
<p><strong>The comparison trap:</strong> Social media is a highlight reel — everyone's best moments, professionally photographed, deliberately curated. The average person appears to be living a significantly better life than they actually are. Comparing your daily experience to others' highlights is biologically rewarding for them and damaging for you.</p>`,
    ...
    q:[
      {q:'What percentage of employers use social media to screen job candidates according to CareerBuilder surveys?',opts:['About 20%','About 40%','Over 70%','Over 90%'],ans:2,explain:'Over 70% of employers screen social media profiles before making hiring decisions. This practice is standard across industries and company sizes — not just large corporations.'},
      {q:'Why are "deleted" social media posts not truly deleted?',opts:['Platforms keep copies for legal reasons and share them with employers on request','Content is cached, screenshotted, and archived by third parties — Archive.org alone saves millions of pages daily','Deleted posts return after 30 days on most platforms','Deletion is only from your view — the content remains on the platform\'s servers permanently'],ans:1,explain:'The open internet creates permanent records through caching, archiving, and screenshot-sharing before deletion is possible. Archive.org\'s Wayback Machine, Google\'s cache, and countless screenshots mean deletion removes the post from your feed but not from the internet.'},
      {q:'Why is having no social media presence potentially a disadvantage in job searching?',opts:['Employers require social media accounts as a hiring condition','No presence is always better than a problematic one','A professional online presence gives employers something good to find — absence is less visible than positive presence','Social media is required for professional references'],ans:2,explain:'While no presence avoids the risk of negative content, a thoughtful professional presence (LinkedIn, portfolio, professional posts) signals initiative, competence, and character. It gives employers positive evidence rather than a blank.'},
      {q:'Social media "highlight reels" affect mental health because:',opts:['Social media is designed by psychologists to cause depression','Algorithm bias ensures only negative content is shown to most users','Comparing your daily experience to others\' carefully curated best moments creates unrealistic social comparison that research links to depression and anxiety','Spending too much time online reduces physical activity, which affects mood'],ans:2,explain:'Research consistently links social comparison on social media to depression and anxiety. The mechanism: posts are deliberately curated best moments, creating the illusion that others are living significantly better lives — an illusion that didn\'t exist before social media.'},
      {q:'What is the recommended approach to monitoring your online reputation?',opts:['Review privacy settings once when you create an account','Check Google about yourself monthly using an incognito browser to see what others see','Delete all social media — the only safe approach','Post frequently to push old content down in search results'],ans:1,explain:'Monthly incognito searches show what others actually see when they search for you (incognito removes personalization). This allows you to identify and address problematic content and understand your current digital footprint.'}
    ]
  }
],
onlinesafety:[
...
<p><strong>Phishing recognition:</strong> Phishing emails are fake messages designed to trick you into entering credentials on a fake website. Red flags: urgency ("your account will be suspended"), unexpected requests, hover over links to see the actual URL before clicking, unexpected attachments. Your bank will never ask for your password via email.</p>`,
    ...
    q:[
      {q:'How do most account breaches actually occur?',opts:['Hackers manually guess passwords using personal information','Sophisticated hacking of individual accounts using advanced tools','Use of leaked password databases from previous breaches to test your credentials on other sites','Physical theft of computers and phones'],ans:2,explain:'Most breaches use "credential stuffing" — taking email/password combinations from known data breaches (gaming sites, old accounts, breached services) and testing them against banking, email, and social media. Reusing passwords is the primary vulnerability.'},
      {q:'Why are authenticator apps (like Google Authenticator) recommended over SMS for two-factor authentication?',opts:['Authenticator apps are faster','SMS 2FA is vulnerable to SIM swapping attacks where criminals hijack your phone number','Authenticator apps work without an internet connection','SMS messages can be read by third parties in transit'],ans:1,explain:'SIM swapping attacks trick mobile carriers into transferring your phone number to a criminal\'s SIM card, allowing them to intercept SMS messages including 2FA codes. Authenticator apps generate codes on your device and aren\'t vulnerable to this attack.'},
      {q:'What is "credential stuffing"?',opts:['Creating many fake accounts to abuse free trials','Using leaked username/password pairs from one breach to attempt login on other services','Physically stealing login credentials by looking over someone\'s shoulder','Intercepting network traffic to capture passwords in transit'],ans:1,explain:'Credential stuffing uses automated tools to test billions of known username/password combinations from data breaches against other websites. Because people reuse passwords, a breach of a low-security site provides access to high-security ones.'},
      {q:'A legitimate email from your bank would:',opts:['Ask you to confirm your password to verify your identity','Include urgent language about account suspension to prompt immediate action','Direct you to the bank\'s official website and never ask for your full password via email or phone','Include your full account number to confirm it\'s genuine'],ans:2,explain:'Banks never request passwords via email. Legitimate security communications direct you to the bank\'s official website (which you should type yourself, not click from the email). Urgency, password requests, and unexpected links are the hallmarks of phishing.'},
      {q:'What does HaveIBeenPwned.com do?',opts:['Sells stolen data to security researchers','Checks if your email address appears in known data breaches so you know if your credentials have been compromised','Tests your current passwords for strength','Monitors your credit report for identity theft'],ans:1,explain:'HaveIBeenPwned.com (run by security researcher Troy Hunt) maintains a database of billions of leaked credentials from known data breaches. Entering your email shows which breaches included it — telling you which services and passwords need immediate attention.'}
    ]
  }
],
entrepreneur:[
...
<p><strong>The three most common startup mistakes:</strong> Building before validating demand. Spending on things that don't generate revenue. Underpricing to attract customers — competing on price is a race to the bottom against larger competitors with more resources.</p>`,
    ...
    q:[
      {q:'What is the difference between revenue and profit?',opts:['Revenue is only from product sales; profit includes service income','Revenue is the total money coming in; profit is what remains after all costs — they are not the same and cannot be treated interchangeably','Revenue is monthly income; profit is annual income','Profit is always a percentage of revenue set by the industry'],ans:1,explain:'Revenue is all money received. Profit is revenue minus all costs (goods, labor, rent, marketing, overhead). Many businesses fail because owners spend revenue as if it\'s all available profit, not accounting for costs.'},
      {q:'Why is talking to 10 potential customers before building a product considered critical?',opts:['Legal requirements mandate market research before launching','It validates that the problem is real and the solution resonates — most failed startups built products nobody wanted','10 conversations guarantee funding from investors','It establishes the customer base needed for a business license'],ans:1,explain:'Customer discovery before building is the most important step most first-time entrepreneurs skip. Most startup failures are products built for problems that weren\'t painful enough to pay to solve, or solutions customers didn\'t want — both discoverable through early conversations.'},
      {q:'Why is competing primarily on low price considered a dangerous strategy for small businesses?',opts:['Customers perceive low-priced products as low quality','Low pricing is illegal in many industries','It starts a race to the bottom against larger competitors with more resources who can always undercut you','Low prices reduce sales volume'],ans:2,explain:'Competing on price against larger competitors is a losing strategy — they have economies of scale, more capital, and can sustain losses longer. Small businesses win by differentiating on quality, service, expertise, or a specific niche — not by trying to be cheapest.'},
      {q:'What is the most common reason businesses fail, according to business research?',opts:['Bad product quality','Running out of cash — even profitable-looking businesses fail when cash flow doesn\'t support operations','Poor marketing','Founder conflict'],ans:1,explain:'Cash flow problems kill more businesses than bad products. A business can be "profitable on paper" but fail because customers pay slowly, costs arrive faster than revenue, or a growth phase requires more cash than available. Watching cash position (not just profit) is critical.'},
      {q:'The fundamental business model that applies to every business is:',opts:['Revenue - Expenses = Profit (the only equation that matters)','Create value people pay for + deliver it + collect more than it costs = profit','Identify a market, create a product, market it, and scale','Solve a problem, patent the solution, license to competitors'],ans:1,explain:'Every business from a lawn mowing service to Amazon operates on this core logic: create something valuable enough for someone to pay for it, deliver it, collect more than it costs to provide. The complexity of modern business layers on top of but never changes these fundamentals.'}
    ]
  }
]};
