...
// ════════════════════════════════════════════════════════════
// 2026-06-07 — Skills Step 2: Power Cards visual upgrade.
//
// SK_DOMAINS groups the 42 categories into 8 thematic clusters that
// appear as Power Cards above the topic grid. Each domain has:
//   icon    — emoji shown inside the progress ring
//   accent  — CSS color used by the progress ring + active glow
//             (reuses existing --section-* tokens where possible)
//   keys[]  — the SK_CATS keys that belong to this domain
//
// Average ~5 categories per domain (range 3-7) so early users see
// meaningful progress on at least one ring after a few certs.
// Tapping a domain card filters #skillsGrid below to that domain's
// categories. Tapping the active domain again (or the All card)
// clears the filter. State lives in _skActiveDomain (module scope).
// ════════════════════════════════════════════════════════════
const SK_DOMAINS = [
  {key:'money',      icon:'💰', name:'Money',      accent:'var(--section-finance, #16a34a)',
  ...
  {key:'career',     icon:'💼', name:'Career',     accent:'#38bdf8',
    keys:['career','college','writing','timemanage','entrepreneur']},
  {key:'digital',    icon:'📱', name:'Digital',    accent:'#2dd4bf',
    keys:['digital','socialmedia','onlinesafety']},
  {key:'relational', icon:'🤝', name:'Relational', accent:'#f472b6',
    keys:['relationships','family','communication']},
  {key:'world',      icon:'🌍', name:'World',      accent:'#f97316',
    keys:['travel','car','emergency','environment','civic','legal']}
];

// Currently-active domain filter ('' or domain key). Setter wraps
// re-render of both the strip (to update active state) and the grid.
let _skActiveDomain = '';
...
dental:[
  ...
  {q:'What actually causes cavities?',opts:['Acidic foods alone eroding enamel','Sugar + bacteria producing acid that slowly erodes enamel over time','Drinking too little water','Grinding teeth while sleeping'],ans:1,explain:'Cavities form when sugar feeds oral bacteria, which produce acid as a byproduct. That acid slowly dissolves tooth enamel. Reducing sugar and brushing after meals breaks this cycle.'},
],
legal:[
  {q:'What is a lease agreement?',opts:['A car payment','A legal rental contract','An insurance policy','A loan'],ans:1,explain:'A lease is a binding contract between landlord and tenant. Once you sign, you are legally responsible for every clause — including ones you did not read.'},
  {q:'Before signing any contract you should:',opts:['Sign immediately','Read every word','Ask a friend','Take a photo'],ans:1,explain:'Always read the entire contract before signing. Pay special attention to auto-renewal clauses, cancellation fees, and binding arbitration sections — they bite later.'},
  {q:'What does liability mean?',opts:['A type of insurance','Legal responsibility','A court fee','A tax form'],ans:1,explain:'Liability means you are legally responsible. If you cause harm or damage, you can be sued and forced to pay. This is why renters insurance, car insurance, and umbrella policies exist.'},
  {q:'What is the statute of limitations?',opts:['How long a law is valid','The time limit to sue someone after an incident','The number of legal documents required','The age you can sign a contract'],ans:1,explain:'After the statute of limitations expires (typically 2-6 years depending on the claim and state), you generally cannot sue — even with a strong case. Do not sit on a legal dispute.'},
  {q:'At what age can you legally sign a binding contract in most U.S. states?',opts:['16','17','18','21'],ans:2,explain:'18 is the age of majority in most states. Contracts signed by minors are usually voidable — meaning the minor can walk away. This is why parents typically co-sign apartment leases and phone contracts for teens.'}
],
adulting:[
  {q:'How often should you check your bank account?',opts:['Once a year','Weekly or more','Only when something looks wrong','Monthly'],ans:1,explain:'Weekly is the floor. Catching a fraudulent charge in 7 days vs 30 days is the difference between an annoyance and a multi-week nightmare of disputes and refunds. Set a recurring calendar reminder.'},
  {q:'What is renters insurance?',opts:['The landlord\'s policy covering the building','Coverage for your belongings against theft, fire, and certain damages','Car insurance for renters','Health insurance bundled with your lease'],ans:1,explain:'Renters insurance protects YOUR belongings — clothes, electronics, furniture. Typically $15-30/month. The landlord\'s insurance covers the building, not your stuff. Many leases now require it.'},
  {q:'How much of your gross income should rent cost?',opts:['Up to 50%','No more than 30%','Whatever the apartment costs','Up to 10%'],ans:1,explain:'The 30% rule: rent should not exceed 30% of gross income. Exceed it and every other category — food, savings, transportation — gets squeezed. In high-cost cities this requires roommates or longer commutes.'},
  {q:'What is an emergency fund and how big should it be?',opts:['$100 in your checking account','3-6 months of essential expenses in a separate savings account','Whatever your credit card limit is','One month of rent'],ans:1,explain:'An emergency fund is 3-6 months of essential expenses (rent, food, utilities, minimum debts) parked in a high-yield savings account. It keeps one bad event — job loss, car repair, medical bill — from becoming credit-card debt.'},
  {q:'Why is automatic bill payment usually safer than manual payment?',opts:['Banks charge fees for manual payments','It prevents the late fees and credit-score damage from forgetting one payment','Automatic payment earns rewards points','Manual payments are illegal in most states'],ans:1,explain:'One missed credit card or loan payment can drop your credit score 50-100 points and trigger a late fee. Autopay for at least the minimum eliminates that risk. Pay the rest manually if you want spending control.'}
],
communication:[
  {q:'The 70/30 listening rule says you should:',opts:['Talk 70%, listen 30%','Listen 70%, talk 30%','Send 70% text, 30% calls','Use 70% email'],ans:1,explain:'In most conversations — especially with new people — listening 70% and talking 30% builds trust faster than the reverse. People remember conversations where they felt heard, not the ones where they were impressed.'},
  {q:'What percentage of in-person communication is non-verbal (body language + tone)?',opts:['About 10%','About 25%','About 55%','About 90%'],ans:2,explain:'Albert Mehrabian\'s research found roughly 55% of in-person emotional communication is body language, 38% is tone, and only 7% is the actual words. Hence text messages misfire so easily — you lose 93% of the signal.'},
  {q:'What is the "steel man" technique?',opts:['Being emotionally tough during arguments','State the other person\'s argument in its strongest form before disagreeing','Never back down from your position','Stick only to verifiable facts'],ans:1,explain:'The steel man technique — opposite of the "straw man" fallacy — is presenting the strongest version of the other side\'s argument before responding. It signals respect, forces you to actually understand their view, and often surfaces points you would have missed.'},
  {q:'What is "active listening"?',opts:['Nodding while waiting to speak','Repeating exactly what the person said','Paraphrasing what you heard to confirm understanding before responding','Listening with no eye contact to avoid pressure'],ans:2,explain:'Active listening means paraphrasing ("So you are saying…") to confirm you understood before you respond. It signals respect, catches misunderstandings early, and de-escalates conflict before it spirals.'},
  {q:'In a difficult conversation, which opener typically works best?',opts:['Lead with what the other person did wrong','Lead with your feelings using "I" statements, then describe the specific behavior','Avoid the conversation until you cool down completely','Bring up everything they have done wrong recently'],ans:1,explain:'"I felt hurt when X happened" lands very differently than "You always do X." The first describes your experience and a specific behavior; the second attacks character and triggers defensiveness.'}
],
diy:[
  {q:'What is the most versatile single tool for general home repair?',opts:['Hammer','Duct tape','Cordless drill','Adjustable wrench'],ans:2,explain:'A cordless drill handles the widest range of tasks — driving screws, drilling pilot holes, mixing paint, even sanding with attachments. It is the one tool worth buying first for a starter home repair kit.'},
  {q:'A constantly running toilet usually needs:',opts:['A whole new toilet','A new flapper (about $5)','A plumber visit','New plumbing pipes'],ans:1,explain:'90% of running toilets are caused by a worn rubber flapper at the bottom of the tank that no longer seals. A replacement costs about $5 at any hardware store and installs in 5 minutes — saves hundreds of dollars on a plumber call.'},
  {q:'When a circuit breaker trips, the correct fix is:',opts:['Call an electrician immediately','Flip the breaker fully OFF first, then back ON','Ignore it — breakers reset themselves','Replace the breaker panel'],ans:1,explain:'Breakers must be flipped fully OFF before going back ON. Halfway-tripped breakers stay in a stuck middle position that looks ON but is not. If a breaker keeps tripping after reset, stop and investigate — something is wrong.'},
  {q:'Before drilling into a wall, what should you check for?',opts:['Whether the wall has been painted recently','Studs, electrical wiring, and plumbing pipes','The age of the house','The wall color'],ans:1,explain:'A $15 stud finder with electrical/AC detection saves you from hitting a wire (shock + repair bill) or a water pipe (flood + repair bill). Always scan before drilling — especially above outlets, switches, or in bathroom/kitchen walls.'},
  {q:'What does it mean when a circuit breaker keeps tripping repeatedly?',opts:['The breaker is too sensitive — replace it with a bigger one','The circuit is overloaded or there is a short — investigate, do not just reset','You should run an extension cord from another room','It is normal in older homes'],ans:1,explain:'A breaker that keeps tripping is doing its job — protecting you from fire. The fix is to unplug devices on that circuit or call an electrician. Replacing the breaker with a "stronger" one is a common DIY mistake that causes house fires.'}
],
shopping:[
  {q:'What is the "24-hour rule" for spending?',opts:['Stores open 24 hours have the best prices','Wait 24 hours before buying anything over about $30','Items must be returned within 24 hours','Always shop at midnight for deals'],ans:1,explain:'Sleeping on a non-essential purchase over $30 kills most impulse buying. The urgency fades; the regret does not. Stores deliberately design shopping flows to bypass this — discounts that "expire today" exist for this reason.'},
  {q:'Unit pricing on a shelf tag shows:',opts:['The total price of the item','The price per ounce, pound, or unit','The current sale discount','The price with tax included'],ans:1,explain:'Unit price (e.g., "$0.14 per ounce") is the only honest comparison between two product sizes. A "bigger value pack" is often more expensive per ounce than the smaller box next to it. Look at the small print on the shelf tag.'},
  {q:'Are generic medications lower quality than brand-name versions?',opts:['Yes, they are weaker','No, the FDA requires generics to be chemically identical to brand-name drugs','Generics are dangerous','Generics are untested'],ans:1,explain:'FDA-approved generics must contain the same active ingredients, in the same amount, with the same purity, absorption, and effect as the brand-name drug. The only difference is packaging and marketing. Generics typically cost 80-85% less.'},
  {q:'What is "shrinkflation"?',opts:['When a store goes out of business','When packaging stays the same size but the product inside shrinks while the price holds or rises','Discount sales on bulk items','When inflation reduces wages'],ans:1,explain:'Manufacturers shrink package contents (a yogurt cup quietly drops from 6oz to 5.3oz) instead of raising the sticker price. Check the unit price ($ per ounce) on the shelf — it is the only honest comparison.'},
  {q:'Loyalty programs and store credit cards are designed primarily to:',opts:['Save you money on every purchase','Reward frequent shoppers with bigger discounts','Increase your spending and lock you to the store, often offsetting any rewards','Provide free shipping'],ans:2,explain:'Studies consistently show loyalty members spend 12-18% more on average — more than offsetting reward value. Take the 5% reward, but do not buy things you would not have otherwise. Store credit cards often charge 25-30% APR — toxic if you carry a balance.'}
],
writing:[
  {q:'A professional email subject line should be:',opts:['Just "Hi" or "Hello"','Specific and actionable','Left blank','In all caps'],ans:1,explain:'"Quick question about Tuesday\'s meeting" gets opened. "Hi" or blank subjects get ignored or buried. The subject is the only thing the recipient sees before deciding to open — make it work for you.'},
  {q:'What should a cover letter actually do?',opts:['Run 3 pages with your full life story','Summarize your resume','Make a persuasive argument for why YOU are right for THIS specific job','Skip it — cover letters are optional now'],ans:2,explain:'A cover letter is your argument for THIS specific role, not a resume summary. One page, three short paragraphs: why this job, what you bring, why now. Generic "Dear Sir/Madam" cover letters get rejected fast.'},
  {q:'When should you send a thank-you note after a job interview?',opts:['Within a week','Within 24 hours','Only if you got the job','Never — it looks desperate'],ans:1,explain:'Within 24 hours, personalized to each interviewer. Mention something specific from the conversation. Hiring managers consistently report this small habit shifts borderline candidates toward the offer.'},
  {q:'What is the most reliable rule for professional email greetings?',opts:['Always use "Dear Sir/Madam"','Match the formality level the recipient uses; default to "Hi [Name]" or "Hello [Name]"','Skip the greeting and get straight to the point','Always use the person\'s full title and last name'],ans:1,explain:'Mirror what the other person uses. "Dear" reads stuffy in most modern work contexts. "Hey" reads too casual for a first email. "Hi [Name]" is the safe middle ground until you see how they sign theirs.'},
  {q:'In professional writing, why is active voice usually preferred over passive?',opts:['Active voice is required by grammar rules','Active sentences are shorter, clearer, and assign responsibility ("I sent the report" vs "The report was sent")','Passive voice is offensive in business','Passive voice is harder to spell-check'],ans:1,explain:'"The decision was made" hides who made it. "We decided" is clearer and accountable. Active voice is shorter and more direct, which respects the reader\'s time and signals competence.'}
],
laundry:[
  {q:'What is the best water temperature for most laundry loads?',opts:['Hot','Warm','Cold','Boiling'],ans:2,explain:'Cold works for about 90% of loads — it cleans well with modern detergents, prevents shrinkage and color bleeding, and uses up to 90% less energy than hot. Save hot water for true cleaning emergencies like sickness, oil-saturated work clothes, or bedbugs.'},
  {q:'Why should you NEVER put a stained item in the dryer?',opts:['It wastes energy','Dryer heat sets stains permanently into the fabric','It breaks the dryer','It causes colors to bleed'],ans:1,explain:'Dryer heat chemically bonds the stain into the fibers — what was treatable now is permanent. Always check stains BEFORE drying. If a stain survives the wash, re-treat and re-wash. Air-dry if you are unsure.'},
  {q:'How often should you wash bed sheets?',opts:['Once a month','Every 1-2 weeks','Once per season','Every day'],ans:1,explain:'Sheets collect sweat, skin cells, and dust mites quickly. Every 1-2 weeks is the dermatologist-recommended baseline. Weekly is better if you sweat heavily, have allergies, or share the bed with a pet.'},
  {q:'How should you treat a stain BEFORE the wash?',opts:['Rub vigorously with hot water','Blot (do not rub) and pre-treat from the back of the fabric, pushing the stain out','Soak the whole garment in bleach','Hide it and hope it disappears'],ans:1,explain:'Rubbing spreads the stain deeper into the fibers. Blot first. Pre-treating from the back pushes the stain out the way it came in — much more effective than treating from the front, which drives it further in.'},
  {q:'Why does over-loading the washing machine leave clothes dirtier?',opts:['Detergent runs out faster','Clothes need room to tumble and agitate — overloading reduces friction and water flow','It damages the machine immediately','It uses more water'],ans:1,explain:'Clothes get clean by moving against each other and the water. A packed drum will not tumble — items clump in a wad. The water + detergent + agitation cycle needs room to work. Fill loosely to the top, not packed.'}
],
cleaning:[
  {q:'What is the most effective first step in a daily home reset?',opts:['Vacuuming everywhere','Walking through with a trash bag and clearing visible junk','Organizing closets','Mopping the floors'],ans:1,explain:'Most "messes" are actually just visible trash and clutter. A 5-minute walk-through with a bag removes 80% of the visual chaos before you do any real cleaning. Start with the easy win, then tackle surfaces.'},
  {q:'What is the most important rule for keeping a kitchen clean?',opts:['Deep clean once a week','Clean as you cook — wash dishes and wipe counters between steps','Only clean on weekends','Use bleach on everything'],ans:1,explain:'A 5-minute cleanup after one meal is trivial. A 90-minute deep clean after a week of meals is misery. Build the habit of washing the prep bowl while the pasta cooks. Same total time, infinitely less dread.'},
  {q:'How do you prevent mold in a bathroom?',opts:['Keep all windows closed','Run the vent fan for 15-20 minutes after every shower','Use only hot water','Never clean it — it cleans itself'],ans:1,explain:'Mold needs moisture to grow. The vent fan removes humidity before it settles into grout, drywall, and ceiling paint. Set a phone timer if you forget to turn it off. Prevention beats scrubbing mold every month.'},
  {q:'Why should you NEVER mix bleach and ammonia (or bleach and vinegar)?',opts:['It stains surfaces permanently','They produce toxic chloramine and chlorine gases that can cause serious lung damage','They cancel each other out','They damage sponges'],ans:1,explain:'Mixing bleach with ammonia (in some glass cleaners) produces chloramine gas. Mixing with vinegar or acidic cleaners produces chlorine gas. Both can cause permanent lung damage. Use one product, ventilate well, wait between cleaners.'},
  {q:'What is the most efficient cleaning order for a room?',opts:['Bottom to top, wet then dry','Top to bottom, dry then wet — dust falls, so clean ceilings/shelves before floors','Random — order does not matter','Skip everything except floors and surfaces'],ans:1,explain:'Top to bottom because dust falls — vacuuming first then dusting just means you vacuum the freshly fallen dust again. Dry tasks (dust, sweep) before wet (mop, wipe) so you do not smear loose dirt around.'}
],
timemanage:[
  {q:'What is the 2-Minute Rule?',opts:['Study in 2-minute chunks','If a task takes under 2 minutes, do it now instead of writing it down','Take a 2-minute break every hour','Spend 2 minutes planning each task'],ans:1,explain:'David Allen\'s 2-Minute Rule eliminates micro-task accumulation. Reply to that one email, hang up that coat, rinse that mug — anything under 2 minutes done now never becomes a 12-item to-do list later.'},
  {q:'When is the best time to plan your upcoming week?',opts:['Monday morning, as the week begins','Friday afternoon, before the weekend','Sunday evening, before the week starts','Whenever you remember'],ans:2,explain:'Sunday-evening planners are 3x more likely to follow through on their week than people who plan Monday morning. The buffer between planning and execution lets your brain pre-process — you wake up Monday already moving.'},
  {q:'The "5-minute start" technique is most useful for:',opts:['Improving sleep quality','Beating procrastination','Cooking faster','Exercising longer'],ans:1,explain:'Commit to just 5 minutes of the dreaded task — that is the entire deal. Most of the time, momentum carries you past the 5-minute mark. The hardest part of any task is starting, not finishing.'},
  {q:'What is the Pomodoro Technique?',opts:['Eat a tomato before working','25 minutes of focused work followed by a 5-minute break, repeated','Plan your day for one full hour every morning','Track every minute of your day in a spreadsheet'],ans:1,explain:'25 minutes focus + 5 minutes break, with a longer break after 4 cycles. It leverages the brain\'s natural attention cycle. The forced break BEFORE exhaustion prevents the focus crash that ruins the next hour.'},
  {q:'According to Parkinson\'s Law, what happens when you give a task a vague deadline like "this week"?',opts:['It gets done faster','Work expands to fill the time allotted — vague deadlines cause vague effort','It gets done with higher quality','The deadline does not matter — only effort does'],ans:1,explain:'A 2-hour task given "this week" takes a week. The same task given "by 3 PM today" takes 2 hours. Tight, specific deadlines force focus. Vague deadlines invite procrastination and drift.'}
],
organize:[
  {q:'What is the "one-touch rule" for processing paper and mail?',opts:['Touch every paper exactly once a day','Decide what to do with each paper the first time you touch it — file, act, or trash','Touch each paper to feel its texture before sorting','Use one finger to flip through stacks'],ans:1,explain:'The one-touch rule eliminates the "shuffle pile." Every time you touch a paper without deciding, you spend time without making progress. Open mail standing next to the recycling bin — most of it lands there immediately.'},
  {q:'Roughly how much time does the average person spend per year looking for misplaced items?',opts:['About 30 minutes','About 5 hours','About 2.5 days','About 2 weeks'],ans:2,explain:'Research suggests the average person spends roughly 2.5 days per year searching for lost items — keys, phones, paperwork. A simple "everything has a home" rule eliminates most of it. The fix is cheap; the loss is invisible but enormous.'},
  {q:'When deciding whether to keep an item, which question is most effective?',opts:['Was it expensive?','Will I actually use it within the next 12 months?','Could someone else use it?','Was it a gift?'],ans:1,explain:'Sentiment, cost, and gift-status all trick you into keeping clutter. "Will I actually use this in the next year?" is a concrete future test that cuts through nostalgia and sunk-cost thinking.'},
  {q:'What is the "in/out" rule for keeping clutter from accumulating?',opts:['Buy 3, discard 1','Buy 1, discard 1','Never discard anything','Replace items only when they break completely'],ans:1,explain:'One-in, one-out keeps possessions in balance. Every new shirt means donating an old one. Without this rule, stuff grows faster than space — which is why most homes feel cluttered within 2-3 years of moving in.'},
  {q:'For digital files, what is the single most effective habit?',opts:['Use the largest hard drive you can afford','Save everything to your desktop for easy access','Use a consistent folder structure and rename files clearly the moment you save them','Email files to yourself as a backup'],ans:2,explain:'Files are easy to save and impossible to find later. Renaming clearly at save-time ("2026-06-tax-return.pdf" beats "Document_47.pdf") and using a consistent folder structure cuts search time by 80%+.'}
],
safety:[
...
sleep:[
  {q:'How many hours of sleep does the CDC recommend for adults (18+)?',opts:['5-6 hours','7-9 hours','10-12 hours','Whatever feels right'],ans:1,explain:'The CDC recommends 7-9 hours for adults 18 and older. Teens 13-18 need 8-10 hours. Chronically getting less than 7 hours is linked to weight gain, depression, heart disease, and impaired immune function.'},
...
function finishSkillQuiz(){
  ...
  if(typeof renderSkillsDomains === 'function') renderSkillsDomains();
  buildSkillsGrid();
}
...
// 2026-06-07 — Skills Step 2: render the domain strip above the
// topic grid. Each domain is a Power Card with a circular SVG
// progress ring (certs earned in domain / total in domain), an
// emoji glyph centered in the ring, the domain name, and the
// "X of Y" caption. "All" card on the left clears the filter.
// Idempotent — call after init and on every cert-earned event.
function renderSkillsDomains(){
  const host = document.getElementById('skDomainStrip');
  if(!host) return;
  const certs = (D && D.skillCerts) ? D.skillCerts : {};
  const totalCerts = Object.values(certs).filter(Boolean).length;
  const allActive = !_skActiveDomain;

  const allCard =
      '<button type="button" class="sk-domain-card sk-dom-all'
    + (allActive ? ' is-active' : '') + '"'
    + ' data-domain=""'
    + ' onclick="setSkDomain(\'\')"'
    + ' aria-label="Show all 42 categories">'
    + '<span class="sk-dom-ring" aria-hidden="true">'
      + '<svg viewBox="0 0 48 48">'
        + '<circle class="sk-dom-ring-track" cx="24" cy="24" r="20"></circle>'
        + '<circle class="sk-dom-ring-fill"  cx="24" cy="24" r="20"'
          + ' stroke-dasharray="125.66"'
          + ' stroke-dashoffset="' + (125.66 * (1 - totalCerts/SK_CATS.length)) + '"></circle>'
      + '</svg>'
      + '<span class="sk-dom-icon">✨</span>'
    + '</span>'
    + '<span class="sk-dom-label">All</span>'
    + '<span class="sk-dom-progress">' + totalCerts + ' of ' + SK_CATS.length + '</span>'
    + '</button>';

  const cards = SK_DOMAINS.map(function(dom){
    const total = dom.keys.length;
    const earned = dom.keys.reduce(function(n, k){ return n + (certs[k] ? 1 : 0); }, 0);
    const pct = total ? (earned / total) : 0;
    const offset = 125.66 * (1 - pct);
    const isActive = (_skActiveDomain === dom.key);
    const mastered = (earned === total && total > 0);
    return '<button type="button" class="sk-domain-card'
      + (isActive ? ' is-active' : '')
      + (mastered ? ' is-mastered' : '') + '"'
      + ' data-domain="' + dom.key + '"'
      + ' style="--dom-accent:' + dom.accent + ';"'
      + ' onclick="setSkDomain(\'' + dom.key + '\')"'
      + ' aria-label="' + dom.name + ' domain, ' + earned + ' of ' + total + ' certs earned' + (isActive ? ', currently filtered' : '') + '">'
      + '<span class="sk-dom-ring" aria-hidden="true">'
        + '<svg viewBox="0 0 48 48">'
          + '<circle class="sk-dom-ring-track" cx="24" cy="24" r="20"></circle>'
          + '<circle class="sk-dom-ring-fill"  cx="24" cy="24" r="20"'
        ...
        + '</svg>'
        + '<span class="sk-dom-icon">' + dom.icon + '</span>'
      + '</span>'
      + '<span class="sk-dom-label">' + dom.name + '</span>'
      + '<span class="sk-dom-progress">' + earned + ' of ' + total + '</span>'
    + '</button>';
  }).join('');

  host.innerHTML = allCard + cards;
}

// Setter — toggles or clears the active domain filter, then re-
// renders both the strip (active state) and the grid (filtered).
function setSkDomain(key){
  // Toggle: tapping the already-active domain card clears the filter.
  if(_skActiveDomain === key) _skActiveDomain = '';
  else _skActiveDomain = key || '';
  renderSkillsDomains();
  // Preserve any active search text on top of the new domain filter.
  const searchEl = document.getElementById('skSearch');
  const searchTxt = searchEl ? searchEl.value : '';
  buildSkillsGrid(searchTxt);
}

function buildSkillsGrid(filter){
  const el = document.getElementById('skillsGrid'); if(!el) return;
  const search = (filter||'').toLowerCase();
  // 2026-06-07 — Skills Step 2: compose search + domain filters.
  // _skActiveDomain (module scope) is set by setSkDomain; '' means
  // no domain filter active.
  let allowedKeys = null;
  if(_skActiveDomain){
    const dom = SK_DOMAINS.find(function(d){ return d.key === _skActiveDomain; });
    if(dom) allowedKeys = new Set(dom.keys);
  }
  el.innerHTML = SK_CATS.map(cat=>{
    if(allowedKeys && !allowedKeys.has(cat.key)) return '';
