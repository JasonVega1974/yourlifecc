...
async function submitSupportBug(){
  ...
  if(!msgEl){ console.error('supportBugMsg element not found'); return; }
  ...
  try{
    ...
    if(resp.ok){
      ...
      (document.getElementById('supportBugDetails')||{}).value='';
    } else {
      console.error('Bug report API error:', resp.status, json);
