...
function finishInit(){
  ...
  setTimeout(function(){
    ...
    if(!IS_DEMO && faithOn && (!D.devPopupSeen || D.devPopupSeen !== today) && !(D.scrReadDays && D.scrReadDays[today]) && !wizardOpen && !kidWizOpen){
      showDailyDevModal();
    }
  }, 1200);
  ...
  if(!IS_DEMO && (!D.parentWizardDone || isNewUser)){ setTimeout(showParentOnboard, 700); }
