...
(function (root) {
  ...
  function _ensureStyles() {
    ...
    var css = ''
      ...
      + '.qp-lib-eyebrow{font-family:var(--fm);font-size:.6rem;font-weight:800;letter-spacing:.22em;text-transform:uppercase;color:#f5c842;}'
      ...
      + '.qp-mode-chip:hover{background:rgba(245,200,66,.12);border-color:rgba(245,200,66,.32);}'
      + '.qp-mode-on{background:#f5c842;border-color:#f5c842;color:#0b1220;}'
      ...
      + '.qp-topic-row:hover{color:#f8d97a;}'
      + '.qp-topic-row:hover .qp-topic-row-arr{color:#f5c842;transform:translateX(3px);}'
      ...
      + '.qp-topic-h::before{content:"";display:inline-block;width:3px;height:1.1rem;background:linear-gradient(180deg,#f5c842,#d97706);border-radius:2px;}'
      ...
      + '.qp-lib-card{background:linear-gradient(180deg,rgba(245,200,66,.06),rgba(15,18,40,.4));border:1px solid rgba(245,200,66,.22);border-radius:16px;padding:1.1rem 1.1rem 1rem;display:flex;flex-direction:column;gap:.7rem;box-shadow:0 6px 20px rgba(0,0,0,.18);}'
      + '.qp-lib-head{display:flex;flex-direction:column;gap:.35rem;}'
      + '.qp-lib-chip{align-self:flex-start;background:rgba(245,200,66,.16);border:1px solid rgba(245,200,66,.32);color:#f6e0a3;font-family:var(--fm);font-size:.62rem;font-weight:800;letter-spacing:.14em;text-transform:uppercase;padding:.22rem .6rem;border-radius:99px;}'
      ...
      + '.qp-lib-btn-pray{display:block;width:100%;margin-top:.4rem;background:linear-gradient(135deg,#f5c842,#d97706);border:none;color:#fff;border-radius:12px;padding:.78rem 1rem;font-family:var(--fh,var(--fm));font-size:.92rem;font-weight:900;letter-spacing:.06em;cursor:pointer;box-shadow:0 8px 22px rgba(217,119,6,.32);transition:transform .15s,box-shadow .2s;}'
      + '.qp-lib-btn-pray:hover{transform:translateY(-2px);box-shadow:0 12px 30px rgba(217,119,6,.44);}'
      ...
      + '.qp-lib-btn:hover{background:rgba(245,200,66,.1);border-color:rgba(245,200,66,.28);color:var(--tx);}'
      ...
      + ':root.light .qp-lib-card{background:#fafaf9;border-color:rgba(217,119,6,.25);color:#1a1233;box-shadow:0 4px 14px rgba(15,23,42,.06);}'
      + ':root.light .qp-lib-text{color:#1a1233;}'
      + ':root.light .qp-lib-chip{background:rgba(217,119,6,.12);border-color:rgba(217,119,6,.3);color:#92400e;}'
      + ':root.light .qp-mode-chip{background:#f5f5f4;border-color:rgba(15,23,42,.12);color:#1a1233;}'
      + ':root.light .qp-mode-on{background:#d97706;border-color:#d97706;color:#fff;}'
      ...
      + ':root.light .qp-topic-row:hover{color:#92400e;}'
      + ':root.light .qp-topic-row:hover .qp-topic-row-arr{color:#d97706;}'
