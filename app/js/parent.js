...
function _openParentSettings(){
  // Require PIN if one is set and not disabled
  if(D.parentPIN && !D.parentPinDisabled){
    _requirePin('Parent Settings','Enter your 6-digit parent PIN',(D.name||'P').charAt(0).toUpperCase(),function(){
      _parentDashUnlocked=true;
