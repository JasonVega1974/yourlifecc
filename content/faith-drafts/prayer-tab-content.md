---
title: Prayer Tab — Full Content Block
category: clg
age_tier: all
scripture_anchor: Philippians 4:6
estimated_minutes: n/a (data file for dev)
status: draft
author_notes: >
  Five structured data sections for the rebuilt Prayer tab. Written for direct
  copy into JS data arrays. All scripture refs are NIV. "Prayer for Enemies"
  is intentionally substantive per Jason's spec — reviewed for tone. No
  sensitive-topic flags needed. Verify Matt 5:44, Ps 139:23-24, and
  Rom 8:26 references against NIV before shipping.
---

## Section 1 — Prayer Types
...
## Section 5 — Lectio Divina Guide for Teens

> Note to dev: The shared practice verse across all four steps is "Be still, and know that I am God." (Psalm 46:10, NIV). It is short enough to memorize, deep enough to sit with across all four movements, and immediately accessible to a first-timer.
